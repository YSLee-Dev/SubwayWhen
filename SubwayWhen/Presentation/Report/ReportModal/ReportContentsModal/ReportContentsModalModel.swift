    ...
    func reportList() -> Observable<[ReportContentsModalSection]>{
        Observable<[ReportContentsModalSection]>.create{
            let data : [ReportContentsModalCellData] = [
                ...
                .init(title: "차내 폭력 사건", iconName: "hand.raised.slash",  contents: "차내에서 폭력사건이 발생하였습니다."),
                .init(title: "차내 전도", iconName: "figure.wave",  contents: "차내에서 전도를 하는 사람이 있습니다."),
                .init(title: "차내 소음", iconName: "ear.trianglebadge.exclamationmark",  contents: "차내에 소음을 유발하는 사람이 있습니다."),
                .init(title: "차내 취객", iconName: "figure.fall",  contents: "차내에 취객이 있어 고성방가를 하고 있습니다."),
                .init(title: "차내 잡상인", iconName: "cart",  contents: "차내에서 잡상인이 물건을 팔고 있습니다."),
                .init(title: "차내 쓰레기", iconName: "trash",  contents: "차내에 쓰레기가 널부러져 있습니다."),
