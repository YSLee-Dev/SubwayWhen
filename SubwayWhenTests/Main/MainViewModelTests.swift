    ...
    func testScheduleCellTransform(){
        ...
        expect(observer.events).to(
            equal([
                ...
                .next(2, [
                    MainTableViewCellData(upDown: "상행", arrivalTime: "000001", previousStation: "", subPrevious: "정보없음", code: "000001", subWayId: "", stationName: "교대", lastStation: "교대행", lineNumber: "1003", isFast: "", useLine: "", group: "", id: "-", stationCode: "", exceptionLastStation: "", type: .schedule, backStationId: "", nextStationId: "", korailCode: ""), mainCellDummyData
                ]),
                .next(5, [
                    MainTableViewCellData(upDown: "상행", arrivalTime: "000001", previousStation: "", subPrevious: "정보없음", code: "000001", subWayId: "", stationName: "교대", lastStation: "교대행", lineNumber: "1003", isFast: "", useLine: "", group: "", id: "-", stationCode: "", exceptionLastStation: "", type: .schedule, backStationId: "", nextStationId: "", korailCode: ""), MainTableViewCellData(upDown: "상행", arrivalTime: "000001", previousStation: "", subPrevious: "정보없음", code: "000001", subWayId: "", stationName: "교대", lastStation: "교대행", lineNumber: "1003", isFast: "", useLine: "", group: "", id: "-", stationCode: "", exceptionLastStation: "", type: .schedule, backStationId: "", nextStationId: "", korailCode: "")
                ]),
                .next(7, [
                    MainTableViewCellData(upDown: "상행", arrivalTime: "000001", previousStation: "", subPrevious: "정보없음", code: "000001", subWayId: "", stationName: "교대", lastStation: "교대행", lineNumber: "1003", isFast: "", useLine: "", group: "", id: "-", stationCode: "", exceptionLastStation: "", type: .schedule, backStationId: "", nextStationId: "", korailCode: ""), MainTableViewCellData(upDown: "상행", arrivalTime: "000001", previousStation: "", subPrevious: "정보없음", code: "000001", subWayId: "", stationName: "교대", lastStation: "사당행", lineNumber: "1003", isFast: "", useLine: "", group: "", id: "-", stationCode: "", exceptionLastStation: "", type: .schedule, backStationId: "", nextStationId: "", korailCode: "")
                ])
            ])
        )
    }
